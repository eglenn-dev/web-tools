...
export function ImageConverter() {
    ...
    return (
        <Card className="w-full max-w-4xl">
            <CardHeader>
                <p className="text-sm text-muted-foreground">Upload file size cannot exceed 1mb.</p>
            </CardHeader>
            <CardContent>
                        ...
                        {(convertedImageUrl && convertedFilename) ? (
                            <div className="flex flex-col items-start">
                                ...
                                <div className="border rounded-md p-2 bg-gray-50">
                                    <img src={convertedImageUrl} alt="Converted WebP" className="max-w-full h-auto" />
                                </div>
                            </div>
                        ) : (
                            <div className='flex items-center justify-center h-48 bg-gray-100 rounded-md'>
                                <p className='text-gray-500'>Converted images will appear here</p>
                            </div>
                        )}
                    </div>
                </div>
